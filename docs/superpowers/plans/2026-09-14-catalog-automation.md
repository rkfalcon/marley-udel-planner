...
3. Run a protected Vercel cron every ten minutes (existing Pro plan): begin checks weekly and resume unfinished checks automatically. Limit work to the function budget, checkpoint batches and retry failed source requests on subsequent runs.
